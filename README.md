...
>
> 현재 버전(`SPI`, `I2C` 스케치)에서 HMC5883L 및 MPU6050 센서 데이터가
> 정상적으로 읽히지 않고 **모든 값이 0으로 저장되는 문제**가 확인됩니다.
>
> - 영향 범위: `SPI/SPI.ino`, `I2C/I2C.ino`
> - 증상: Flash 및 시리얼 출력에서 X/Y/Z 가속도·자이로·자기장 값이 모두 0
> - 상태: 미해결 (원인 분석 중)
